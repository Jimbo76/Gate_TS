...
function (_super) {
  ...
  LoadScene.prototype.loadSprites = function (frameConfig) {
    ...
    for (var prop in CST_1.CST.SPRITES) {
      this.load.spritesheet(CST_1.CST.SPRITES[prop], CST_1.CST.SPRITES[prop], frameConfig);
    }
  };
  ...
  LoadScene.prototype.preload = function () {
    ...
    this.load.atlas("daze", "./assets/atlas/daze.png", "./assets/atlas/daze.json"); // Load Images, Spritesheets, Sound
    ...
    */
    ...
    this.load.on("complete", function () {// this.scene.start(CST.SCENCES.MENU);
    });
  ...
  LoadScene.prototype.create = function () {
    this.scene.start(CST_1.CST.SCENCES.MENU);
  };
...
function (_super) {
  ...
  MenuScene.prototype.create = function () {
    var _this = this; // Create Images


    this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.20, CST_1.CST.IMAGES.LOGO).setDepth(1);
    this.add.image(0, 0, CST_1.CST.IMAGES.TITLE).setOrigin(0, 0).setDepth(0);
    var playButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2, CST_1.CST.IMAGES.PLAY).setDepth(1);
    var optionsButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2 + 100, CST_1.CST.IMAGES.OPTIONS).setDepth(1); // Create Sprites

    var hoverSprite = this.add.sprite(100, 100, CST_1.CST.SPRITES.CAT);
    ...
    this.anims.create({
      ...
      frameRate: 4,
      repeat: -1,
      frames: this.anims.generateFrameNumbers(CST_1.CST.SPRITES.CAT, {
        frames: [0, 1, 2, 3]
      })
    });
    /*
    ...
    */
    ...
    playButton.on("pointerout", function () {
      hoverSprite.setVisible(false); // hoverSprite.anims.pause();
    });
    playButton.on("pointerup", function () {
      _this.scene.start(CST_1.CST.SCENCES.PLAY);
...
function (_super) {
  ...
  PlayScene.prototype.create = function () {
    var pimple = this.add.sprite(100, 100, "daze", "daze08.png").play("dazzle");
    var anna = this.add.sprite(400, 400, "anna").setScale(2);
    var hooded = this.add.sprite(200, 200, "hooded").setScale(2).play("right"); // window.hooded = hooded;
    // window.anna = anna;
  };
