...
function (_Phaser$Scene) {
  ...
  _createClass(LoadScene, [{
    ...
    value: function preload() {
      ...
      this.load.audio("title_music", "./assets/audio/shuinvy-childhood.mp3"); // Create Loading Bar
      ...
      */
      ...
      this.load.on("complete", function () {// this.scene.start(CST.SCENCES.MENU, "Hello World");
      });
    }
  }, {
    key: "create",
    value: function create() {
      this.scene.start(_CST.CST.SCENCES.MENU, "Hello World");
    }
  }, {
    key: "update",
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function create() {
      ...
      var optionsButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2 + 100, "options_button").setDepth(1); // Create Sprites
